    <div id="Content">
        ...
        <ul class="nav-tab nav nav-pills nav-stacked list-group">
            <li id="sidebar-abst"><a href="#abst">簡介</a></li>
            <li id="sidebar-core"><a href="#core">團隊</a></li>
        </ul>
        </div>
        <div class="main-content-with-sidebar">
            <h3 id="abst">系學會簡介 <small>Student Association Abstractions</small></h2>
                <div class="Content-Text">
                    ...
                    <ul>
                        <li>
                            <address>32003桃園縣中壢市遠東路135號<br>
                            七館三樓R70310
                            </address>
                        </li>
                        <li>
                            <address>
                                R70310, No.135, Yuan-tung Rd.,<br>
                                Chungli City 32003, Taiwan
                            </address>
                        </li>
                    </ul>
